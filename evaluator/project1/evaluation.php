...
$sqlStud = "SELECT * FROM student JOIN project_student USING (studID) JOIN mark_student USING (titleID) JOIN lecturer USING (lectID) WHERE lectID='$id' AND (posID=1002 OR posID=1004) AND semester='$rowSem[details]'";
