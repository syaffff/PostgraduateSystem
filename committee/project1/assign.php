		...
		<table>
          <tbody>
            ...
            <tr>
                ...
                <td><a href="#newModal?studID=<?php echo $row['studID']; ?>" data-toggle="modal"><img src="../../left/img/mono-icons/pencilplus32.png" /></a></td>
                <?php include 'modal/assignSV.php';?>
            </tr>            
            <?php
		...
		<table>
          <tbody>
            ...
            <tr>
                ...
                <td><a href="#viewModal" class="edit_data" id="<?php echo $row['studID']; ?>" data-toggle="modal"><img src="../../left/img/mono-icons/linedpaperpencil32.png" /></a></td>
                <?php include 'modal/viewSV.php';?>
            </tr>            
            <?php
